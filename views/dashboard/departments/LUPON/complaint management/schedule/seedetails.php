        ...
        <nav class="sidebar" style="z-index: 1000;">
            <div class="sidebar-content">
                ...
                <div class="sidebar-category">
                    ...
                    <a href="http://localhost:3000/views/dashboard/departments/LUPON/complaint%20management/issuecfa.php" class="sidebar-link" style="text-decoration: none; color: inherit;">
