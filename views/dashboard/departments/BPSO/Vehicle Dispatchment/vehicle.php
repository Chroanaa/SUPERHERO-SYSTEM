...
<body>
    <div id="app">
        ...
        <div style="position: relative; top: 0; left: 0; height: 104px; width: 100%; border: 1px solid #d4d4d4; background-color: #ffffff; display: flex; align-items: center; padding-left: 20%; ">
            <h1 style="font-size: 2rem;">VEHICLE DISPATCHMENT</h1>
        </div>
        <div style="margin-top: 13px; padding: 20px; min-height: 100vh; width: 100%; box-sizing: border-box; background-color: #ffffff; display: flex; flex-direction: column; align-items: flex-start;">
            <div style="display: flex; justify-content: flex-start; align-items: center; gap: 40px; margin-left: 25%;">
                <div id="l300-truck-1" class="clickable-div" style="width: 280px; height: 150px; padding: 20px; font-weight: 600; text-align: center; background-color: #ffffff; color: #004084; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 8px rgba(56, 56, 56, 0.5);">
                    <span style="background-color: #cfdfef; padding: 5px 20px; border-radius: 15px; border: 2px solid #006bdd;">
                        <i style="margin-right: 5px;"></i>L300 1
                    </span>
                    <i class="fas fa-truck" style="position:relative; color: #303030; font-size: 60px; padding: 20px 30px;"></i>
                </div>
                <div id="l300-truck-2" class="clickable-div" style="width: 280px; height: 150px; padding: 20px; font-weight: 600; text-align: center; background-color: #ffffff; color: #004084; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 8px rgba(56, 56, 56, 0.5);">
                    <span style="background-color: #cfdfef; padding: 5px 20px; border-radius: 15px; border: 2px solid #006bdd;">
                        <i style="margin-right: 5px;"></i>L300 2
                    </span>
                    <i class="fas fa-truck" style="position:relative; color: #303030; font-size: 60px; padding: 20px 30px;"></i>
                </div>
                <div id="l300-truck-3" class="clickable-div" style="width: 280px; height: 150px; padding: 20px; font-weight: 600; text-align: center; background-color: #ffffff; color: #004084; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 8px rgba(56, 56, 56, 0.5);">
                    <span style="background-color: #cfdfef; padding: 5px 20px; border-radius: 15px; border: 2px solid #006bdd;">
                        <i style="margin-right: 5px;"></i>L300 3
                    </span>
                    <i class="fas fa-truck" style="position:relative; color: #303030; font-size: 60px; padding: 20px 30px;"></i>
                </div>
            </div>
            <div style="display: flex; justify-content: flex-start; align-items: center; gap: 40px; margin-top: 7%; margin-left: 25%;">
                <div id="ambulance-1" class="clickable-div" style="width: 280px; height: 150px; padding: 20px; font-weight: 600; text-align: center; background-color: #ffffff; color: #004084; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 8px rgba(56, 56, 56, 0.5);">
                    <span style="background-color: #cfdfef; padding: 5px 20px; border-radius: 15px; border: 2px solid #006bdd;">
                        <i style="margin-right: 5px;"></i>Ambulance 1
                    </span>
                    <i class="fas fa-ambulance" style="position:relative; color: #303030; font-size: 60px; padding: 20px 30px;"></i>
                </div>
                <div id="ambulance-2" class="clickable-div" style="width: 280px; height: 150px; padding: 20px; font-weight: 600; text-align: center; background-color: #ffffff; color: #004084; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 8px rgba(56, 56, 56, 0.5);">
                    <span style="background-color: #cfdfef; padding: 5px 20px; border-radius: 15px; border: 2px solid #006bdd;">
                        <i style="margin-right: 5px;"></i>Ambulance 2
                    </span>
                    <i class="fas fa-ambulance" style="position:relative; color: #303030; font-size: 60px; padding: 20px 30px;"></i>
                </div>
            </div>
