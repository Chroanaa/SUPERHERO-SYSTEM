...
export const sidebarRoutes = [
    ...
    { className: "main", path: "/views/dashboard/departments/BPSO/Dashboard/dashboard.php" },
    { className: "complaint-section", path: "/views/dashboard/departments/BPSO/Complaint%20main/complaints.php" },
    { className: "new-complaint", path: "/views/dashboard/departments/BPSO/Complaint%20main/newcomplaint.php" },
