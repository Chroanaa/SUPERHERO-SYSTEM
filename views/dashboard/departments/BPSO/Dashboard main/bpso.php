...
// Add content to be displayed at the top
echo '
   <div style="text-align: center; margin-bottom: 20px;">
       <h2>Complaints Overview</h2>
       <p>Below is the list of complaints received. Click on "See details" for more information or "Forward" to process the complaint.</p>
   </div>
   ';

echo '
   <table id="tablecase" class="table table-bordered" style="left: 23%; width: 1500px; top: 70px; position: relative; border: 1px solid #d4d4d4; z-index: 1; text-align: center;">
       <thead>
           <tr>
...
if ($stmt->rowCount() > 0) {
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    echo "
           <tr>
               ...
               <td>
                   <button type='button' class='btn btn-success btn-hover' style='font-weight: 500;'>
                       See details
                   </button>
                   <button type='button' class='btn btn-danger btn-hover' style='font-weight: 500;'>
                       Forward
                   </button>
               </td>
           </tr>
  ...
  echo "
       <tr>
           <td colspan='7'>No table record</td>
       </tr>
       ";
}
  ...
  <div id="app">
      ...
      <div class="sidebar-content">
        ...
        <div class="sidebar-category">
          <div class="sidebar-category-header" onclick="toggleSubMenu()">
            <span>
              <i class="fas fa-shield-alt category-icon">
              </i>
              Brgy. Public Safety Officer
            </span>
          ...
          <div class="sidebar-submenu-show">
            ...
            <div class="sidebar-submenu-item" onclick="showSection('newcomplaintsection')">
              New Complaint
            </div>
            <div class="sidebar-submenu-item" onclick="showSection('reportsection')">
              Create Report
            </div>
          </div>
        </div>
        ...
        <div class="sidebar-category">
          <div class="sidebar-category-header" data-bs-toggle="modal" data-bs-target="#signOutModal">
            <span>
              <i class="fa-solid fa-door-open category-icon">
              </i>
              Sign Out
            </span>
          </div>
    ...
    <section id="dasboardsection">
      <div style="position: relative; height: 130px; width: 100%; top: -27px; border: 1px solid #d4d4d4; background-color: #ffffff;">
        <h1 style="position: absolute; top: 35px; left: 21%;">
          DASHBOARD
        </h1>
      </div>
    ...
    < <!-- Complaint management-->
      <section id="complaintsection" style="display: none;">
        ...
        <div style="position: absolute; top: 114px; bottom: 0; height: 1000px; width: 100%; border: 1px solid #d4d4d4; background-color: #ffffff;">
          <input type="text" id="search-input" placeholder="Search..." onkeyup="filterTable()"
            style="padding: 10px; position: relative; top: 60px; left: 470px; width: 700px;">
          <!-- Category dropdown -->
          <div class="dropdown" style="position: relative; display: flex; justify-content: center; align-items: center; height: 200px; top: 70px; left: -380px;">
            <button id="dropdownButton" class="btn btn-info dropdown-toggle btn-hover"
              type="button" data-bs-toggle="dropdown" aria-expanded="false" style="position: relative; display: block; width: 300px; height: 50px; font-size: 20px; background-color: #ffffff; border: 1px solid #b1b1b1; z-index: 2;">
              Category
            </button>
            <ul class="dropdown-menu" style="z-index: 2;">
              <li>
                <a class="dropdown-item" href="#" onclick="selectCategory('Minor case')">
                  Minor case
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#" onclick="selectCategory('Major case')">
                  Major case
                </a>
              </li>
            </ul>
      ...
      <section id="newcomplaintsection" style="display: none;">
        ...
        <div style="position: absolute; top: 114px; bottom: 0; height: 1350px; width: 100%; border: 1px solid #d4d4d4; background-color: #ffffff;">
          <form action="../../../../../controllers/departments/BPSO/complaint.php"
            method="POST">
            <!-- complainant-->
            <label style="position: absolute; top: 50px; left: 450px; font-size: 20px; font-weight: 600;">
              Complainant 1
            </label>
            ...
            <button type="button" id="add-button" onclick="addComplainant()" style="position: absolute; top: 230px; left: 22%; font-size: 20px; background-color: #009717; color: #ffffff; border-radius: 50%; width: 30px; height: 30px; cursor: pointer; display: flex; justify-content: center; align-items: center;">
              +
            </button>
            <!-- Respondent Section -->
            <label style="position: absolute; top: 50px; right: 460px; font-size: 20px; font-weight: 600;">
              Respondent 1
            </label>
            ...
            <button type="button" id="add-buttons" onclick="addRespondent()" style="position: absolute; top: 230px; right: 29%; font-size: 25px; background-color: #009717; color: #ffffff; border-radius: 50%; width: 30px; height: 30px; cursor: pointer; display: flex; justify-content: center; align-items: center;">
              +
            </button>
            <!-- complaint category-->
            <div class="dropdown" style="position: relative; display: flex; justify-content: center; align-items: center; height: 200px; top: 450px; left: -18%;">
              ...
              <!-- Hidden input for complaint category -->
              <button id="dropdowncategory" class="btn btn-info dropdown-toggle btn-hover"
                type="button" data-bs-toggle="dropdown" aria-expanded="false" style="position: relative; font-weight: 500; display: block; width: 390px; height: 50px; font-size: 20px; background-color: #ffffff; border: 1px solid #b1b1b1; z-index: 2;">
                Case Type
              </button>
              <ul class="dropdown-menu" style="z-index: 2; position: absolute; top: 100%; left: 0;">
                <li type="button" onclick="updateButtonText('Minor case', 'dropdowncategory', event)"
                  class="dropdown-item" style="cursor: pointer;">
                  Minor case
                </li>
                <li type="button" onclick="updateButtonText('Major case', 'dropdowncategory', event)"
                  class="dropdown-item" style="cursor: pointer;">
                  Major case
                </li>
              </ul>
            ...
            <label for="complaint-description">
              Ilagay ang iyong reklamo:
            </label>
            <textarea id="complaint-description" name="complaint_description" placeholder="Complaint description..."
              style="position: relative; left: 12%; top: 570px; height: 300px; width: 1350px; border: 1px solid #b1b1b1; border-radius: 3px; padding: 15px; font-size: 20px;">
      </textarea>
            <input type="text" id="complainantincident" name="place_of_incident" placeholder="Place of Incidence..."
              style="position: absolute; left: 445px; top: 635px; padding: 13px; font-size: 20px; height: 50px; width: 400px; border-radius: 3px; border: 1px solid #d4d4d4; background-color: #ffffff;">
            ...
            <button type="button" id="openModalButton" class="btn btn-primary btn-hover"
              style="position: relative; font-weight: 500; right: 45px; top: 720px; width: 300px; height: 60px; font-weight: 600; font-size: 20px;">
              Confirm
            </button>
            <div class="dropdowns" style="position: relative; display: flex; justify-content: center; align-items: center; height: 200px; top: 590px; left: -18%;">
              ...
              <button id="specialcasedrop" class="btn btn-info dropdown-toggle btn-hover"
                type="button" data-bs-toggle="dropdown" aria-expanded="false" style="position: relative; font-weight: 500; display: block; width: 390px; height: 50px; font-size: 20px; background-color: #ffffff; border: 1px solid #b1b1b1; z-index: 2;">
                Special Case Involved
              </button>
              <ul class="dropdown-menu" style="z-index: 2; position: absolute; top: 100%; left: 0;">
                <li type="button" onclick="updateButtonText('BCPC', 'specialcasedrop', event)"
                  class="dropdown-item" style="cursor: pointer;">
                  BCPC
                </li>
                <li type="button" onclick="updateButtonText('BADAC', 'specialcasedrop', event)"
                  class="dropdown-item" style="cursor: pointer;">
                  BADAC
                </li>
                <li type="button" onclick="updateButtonText('None', 'specialcasedrop', event)"
                  class="dropdown-item" style="cursor: pointer;">
                  None
                </li>
              </ul>
            ...
            <div id="report-create" class="create">
              <div class="create-content">
                ...
                <h1 style="position: absolute; left: 30%; top: 8%; font-size: 40px">
                  COMPLAINT FILED
                </h1>
                ...
                <button type="submit" id="submitbutton" class="btn btn-primary btn-hover"
                  style="position: absolute; width: 300px; height: 60px; font-weight: 600; font-size: 20px; bottom: 40px; left: 34%;">
                  Submit
                </button>
              </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-danger" id="confirmSignOutBtn" data-bs-dismiss="modal">
                Sign Out
              </button>
            </div>
          </div>
