        ...
        <script>
            ...
            const sampleData = {
                1: {
                    ...
                    description: "Request to re-evaluate financial budget allocations.",
                    reasonForDisregarding: "The request is not within the scope of the department."
                },
                2: {
                    ...
                    reasonForDisregarding: "Duplicate submission already handled previously."
                }
            };

            // Check if localStorage already contains data; if not, add the sample data
            if (!localStorage.getItem("disregardedRequest")) {
                localStorage.setItem("disregardedRequest", JSON.stringify(sampleData));
            }
